...
import copy
from bidastereo.models.bidastereo_model import BiDAStereoModel
from pytorch3d.implicitron.tools.config import get_default_args
try:
    from bdastereo.models.raft_stereo_model import RAFTStereoModel
    MODELS = [RAFTStereoModel, BiDAStereoModel]
except:
